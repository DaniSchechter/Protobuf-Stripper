...
bool is_forbidden(const std::string& src_ip, const std::string& dst_ip, const std::string& src_port, const std::string& dst_port, const std::string& data)
{
	...
	bool bport_density = port_density(src_ip, dst_ip, src_port, dst_port);
